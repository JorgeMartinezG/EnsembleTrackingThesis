...
a treshold $b$. On each sequence, these two measures are calculated using
...
the \gls{gt} position in the first frame. We summarize employing the precision and success plots for complete dataset.

...
\begin{figure}[h!]
	...
	subtraction. Foreground pixels are drawn in white. Figure taken from
	\cite{Pham2010}}
	\label{fig::bg_sub}
\end{figure}
...
\caption[Interest points for object detection]
		...
		right - SIFT. Figure taken from \cite{Yilmaz2006}.}
\end{figure}
...
\begin{figure}[t]
	...
	the	process is repeated. Figure taken from \cite{Grabner2006}}
...
\begin{figure}[h!]
	...
	\caption[Illustration of an active contour representation]
			...
			image displays contour result. Figure taken from \cite{Yilmaz2006}}
	\label{fig::contour}
\end{figure}	

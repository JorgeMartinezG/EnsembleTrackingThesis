...
particular circumstances. Based on the above, we present in this section 
...
For all our experiments we set this value to $0.8$, which is interpreted as
...
which applied SVM classifier \cite{zhang2014meem,Bai2013}, obtained better results
